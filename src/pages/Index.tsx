  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, hsla(220, 65%, 50%, 0.12) 0%, transparent 70%)" }}
      />

      <div
        className="hero-gradient-orb w-[500px] h-[500px] top-[30%] -right-[150px] fixed"
        style={{ background: "radial-gradient(circle, hsla(265, 45%, 55%, 0.08) 0%, transparent 70%)" }}
      />

      <div
        className="hero-gradient-orb w-[400px] h-[400px] bottom-[10%] left-[20%] fixed"
        style={{ background: "radial-gradient(circle, hsla(8, 65%, 58%, 0.06) 0%, transparent 70%)" }}
      />
