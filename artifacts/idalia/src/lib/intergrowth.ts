/**
 * INTERGROWTH-21st Fetal Growth Standards — OFFICIAL published centile tables
 * Source: International Fetal Growth Standards, University of Oxford.
 *   Papageorghiou AT et al., Lancet 2014;384:869-79 (biometry: HC, AC, FL, BPD).
 *   Stirnemann J et al., Ultrasound Obstet Gynecol 2017 (EFW).
 * Values extracted verbatim from the official centile tables (media.tghn.org,
 * GROW_*_ct_Table PDFs). Cross-checked against the gigs reference package.
 *
 * Centiles P3, P10, P50, P90, P97.
 *   Biometry (HC/AC/FL/BPD, mm): GA 14-40 weeks.
 *   EFW (g): GA 22-40 weeks (the INTERGROWTH-21st EFW standard is not defined < 22 weeks).
 */
...
export const GROWTH_PARAMS: GrowthParameterMeta[] = [
  ...
  },
  {
    key: "hc",
    label: "CC",
    fullName: "Circunferência Cefálica",
    unit: "mm",
    minGA: 14,
    maxGA: 40,
  },
  {
    key: "ac",
    label: "CA",
    fullName: "Circunferência Abdominal",
    unit: "mm",
    minGA: 14,
    maxGA: 40,
  },
...
// ── EFW (grams) — INTERGROWTH-21st / Stirnemann 2017 (GA 22-40) ──
...
// ── HC (mm) — INTERGROWTH-21st / Papageorghiou 2014 ──
...
// ── AC (mm) — INTERGROWTH-21st / Papageorghiou 2014 ──
...
// ── FL (mm) — INTERGROWTH-21st / Papageorghiou 2014 ──
...
// ── BPD (mm) — INTERGROWTH-21st / Papageorghiou 2014 ──
