    ...
    <div className="relative w-screen h-screen overflow-hidden bg-bg font-body text-ink">
      ...
      <div className="absolute left-[6vw] top-[18vh] w-[34vw]">
        <h2 className="font-serif text-[4.6vw] leading-[1] tracking-tight text-primary text-balance">
          Designed for the
          <span className="italic text-accent"> pace of the clinic.</span>
        </h2>
        ...
        <div className="mt-[5vh] flex flex-col gap-[2.5vh]">
          <div className="flex items-start gap-[1.2vw]">
            ...
            <div>
              <div className="text-[1.7vw] font-semibold leading-snug">Minimal input</div>
              <p className="text-[1.5vw] leading-snug text-muted text-pretty">
                Just the exam measurements. No mandatory patient registration.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-[1.2vw]">
            <span className="font-serif text-[2.6vw] leading-none text-accent mt-[0.3vh]">→</span>
            <div>
              <div className="text-[1.7vw] font-semibold leading-snug">Live percentiles</div>
              <p className="text-[1.5vw] leading-snug text-muted text-pretty">
                Results classified and plotted on the curve as the clinician
                types.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-[1.2vw]">
            <span className="font-serif text-[2.6vw] leading-none text-accent mt-[0.3vh]">→</span>
            <div>
              <div className="text-[1.7vw] font-semibold leading-snug">Report-ready</div>
              <p className="text-[1.5vw] leading-snug text-muted text-pretty">
                A text block ready to paste into the patient record, with
                references.
              </p>
            </div>
          </div>
      ...
      <div className="absolute right-[6vw] top-[16vh] bottom-[10vh] w-[48vw]">
        <div className="relative h-full w-full rounded-[2vh] bg-white shadow-[0_4vh_8vh_-2vh_rgba(19,48,105,0.18)] border border-line overflow-hidden">
          ...
          <div className="flex items-center gap-[0.6vw] px-[1.5vw] py-[1.5vh] border-b border-line">
            ...
            <span className="w-[1.2vh] h-[1.2vh] rounded-full bg-line" />
            <span className="w-[1.2vh] h-[1.2vh] rounded-full bg-line" />
            <span className="ml-[1vw] text-[1.1vw] text-muted">idaliacalc.com / biometry</span>
          </div>

          {/* Mock calc UI */}
          <div className="p-[3vh_2.5vw] grid grid-cols-[1.1fr_1fr] gap-[2vw] h-[calc(100%-5vh)]">
            <div>
              <div className="text-[1.1vw] uppercase tracking-[0.2em] text-accent font-semibold">Fetal biometry</div>
              <div className="font-serif text-[2.6vw] leading-tight text-primary mt-[0.5vh]">Composite biometry</div>

              <div className="mt-[3vh] flex flex-col gap-[1.5vh]">
                <div className="flex items-center justify-between border-b border-line pb-[1vh]">
                  <span className="text-[1.4vw] text-muted">BPD</span>
                  <span className="text-[1.6vw] font-semibold">78 mm</span>
                </div>
                <div className="flex items-center justify-between border-b border-line pb-[1vh]">
                  <span className="text-[1.4vw] text-muted">HC</span>
                  <span className="text-[1.6vw] font-semibold">282 mm</span>
                </div>
                <div className="flex items-center justify-between border-b border-line pb-[1vh]">
                  <span className="text-[1.4vw] text-muted">AC</span>
                  <span className="text-[1.6vw] font-semibold">271 mm</span>
                </div>
                <div className="flex items-center justify-between border-b border-line pb-[1vh]">
                  <span className="text-[1.4vw] text-muted">FL</span>
            ...
            <div className="bg-primary text-white rounded-[1.5vh] p-[2vh_1.5vw] flex flex-col">
              <div className="text-[1.1vw] uppercase tracking-[0.2em] text-white/70">Result</div>
              <div className="mt-[1.5vh]">
                <div className="text-[1.2vw] text-white/70">Gestational age</div>
                <div className="font-serif text-[3.4vw] leading-none mt-[0.5vh]">31w 4d</div>
              </div>
              <div className="mt-[3vh]">
                <div className="text-[1.2vw] text-white/70">EFW (Hadlock)</div>
              ...
              <div className="mt-auto pt-[2vh] border-t border-white/15">
                <div className="text-[1.2vw] text-white/70">Percentile</div>
