    ...
    <div className="relative w-screen h-screen overflow-hidden bg-bg font-body text-ink">
      ...
      <div className="absolute left-[6vw] top-[18vh] max-w-[88vw]">
        ...
        <h2 className="font-serif text-[5.4vw] leading-[1] tracking-tight text-primary text-balance max-w-[70vw]">
          Uma única plataforma para todos os cálculos
          <span className="italic text-accent"> da obstetrícia moderna.</span>
        </h2>
      </div>
      ...
      <div className="absolute left-[6vw] right-[6vw] bottom-[9vh] grid grid-cols-3 gap-[3vw]">
        <div>
          ...
          <div className="text-[1.7vw] font-semibold text-ink mb-[1vh]">Datação e biometria</div>
          <p className="text-[1.5vw] leading-snug text-muted text-pretty">
            IG por DUM, USG, CCN, DBP e biometria composta — em uma única tela.
          </p>
        </div>
        <div>
          <div className="font-serif text-[4vw] leading-none text-accent mb-[1.5vh]">02</div>
          <div className="text-[1.7vw] font-semibold text-ink mb-[1vh]">Crescimento e Doppler</div>
          <p className="text-[1.5vw] leading-snug text-muted text-pretty">
            PFE, curva INTERGROWTH-21st e velocimetria umbilical, cerebral e
            uterina.
          </p>
        </div>
        <div>
          <div className="font-serif text-[4vw] leading-none text-secondary mb-[1.5vh]">03</div>
          <div className="text-[1.7vw] font-semibold text-ink mb-[1vh]">Rastreamento de risco</div>
          <p className="text-[1.5vw] leading-snug text-muted text-pretty">
            Trissomias do 1.º trimestre e pré-eclâmpsia pelo modelo FMF / ASPRE.
          </p>
        </div>
      </div>
    </div>
